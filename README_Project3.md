...
3. **HTML Visualizations** (generated from notebook, saved to `/content/` in Colab)
...
1. **GitHub Pages** - Host HTML files in a repository
2. **Tableau Public** - Convert to Tableau dashboard (if needed)
3. **Personal Portfolio** - Embed into your website
4. **Observable** - Interactive notebook format
...
<html>
<head>
    <title>Space Debris Visualization Suite</title>
</head>
<body>
    <h1>Our Stuff In Space</h1>
    <iframe src="growth_timeline.html" width="100%" height="600"></iframe>
